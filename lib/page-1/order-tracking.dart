        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              top: 490*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(20*fem, 30*fem, 20*fem, 8*fem),
                width: 375*fem,
                height: 322*fem,
                decoration: BoxDecoration (
                  color: Color(0xff000000),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  padding: EdgeInsets.fromLTRB(8*fem, 7*fem, 0*fem, 9*fem),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  // group33293Rsm (2:211)
                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 25*fem, 16*fem),
                                  width: double.infinity,
                                  height: 40*fem,
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment.start,
